...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='HL3')
    ...
    parser.add_argument('--model', type=str, required=True, default='HL3',
                        help='model name, options: [FreDF, FiLM, FEDformer]')
    ...
    parser.add_argument('--is_emb', type=bool, default=True, help='emb or not')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_lr{}_df{}_eb{}_dp{}_{}_{}'.format(
